...
import com.studio.googleplay.activity.BaseActivity;
...
public class PagerTab extends ViewGroup {
	...
	private int mTabBackgroundResId = R.drawable.selector_bg_tab_text;// tab背景资源
	private int mTabTextColorResId = R.color.selector_tab_text_color; //tab文字颜色
	...
	private void addTextTab(final int position, String title) {
		...
		tab.setTextColor(UiUtils.getResColorStateList(mTabTextColorResId));
		tab.setBackgroundDrawable(UiUtils.getResDrawable(mTabBackgroundResId));
