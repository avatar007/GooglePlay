...
public class HomeDetailActivity extends BaseActivity {
    ...
    private View onCreateSuccessView() {
        ...
        //添加应用详情页的布局
        FrameLayout flDetailInfo = (FrameLayout) view.findViewById(R.id.fl_detail_appinfo);
        ...
        //添加安全信息页面的布局
        FrameLayout flSafeInfo = (FrameLayout) view.findViewById(R.id.fl_detail_safe);
        DetailSafeHolder safeHolder = new DetailSafeHolder();
        safeHolder.setData(data);
        flSafeInfo.addView(safeHolder.getRootView());

        //添加截图模块页面布局
        HorizontalScrollView hsvScreenInfo = (HorizontalScrollView) view.findViewById(R.id.hsv_detail_screen);
        ...
        //添加描述模块页面布局
        FrameLayout flDesInfo = (FrameLayout) view.findViewById(R.id.fl_detail_des);
